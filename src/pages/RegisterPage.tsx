...
const RegisterPage: React.FC = () => {
  ...
  const { user, register, loginWithGoogle, loginWithFacebook, isLoading } = useAuth();
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-gray-700 dark:text-gray-300">{t('auth.loginWithGoogle')}</span>
              </button>
              ...
              >
                ...
                <span className="text-gray-700 dark:text-gray-300">{t('auth.loginWithFacebook')}</span>
              </button>
            </div>
