...
const CheckoutPage: React.FC = () => {
  ...
  const { items, updateQuantity, removeFromCart, clearCart, getTotalPrice, getTotalCoinPrice } = useCart();
  const { user } = useAuth();
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-3">
                ...
                <div className="flex items-center justify-between mt-1">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Or pay with coins:</span>
                  <div className="flex items-center text-yellow-600 dark:text-yellow-400">
                    <Coins size={16} className="mr-1" />
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => setPaymentMethod(e.target.value as 'coins')}
                  disabled={!canPayWithCoins}
                  className="text-blue-600"
                />
                <div className="flex items-center space-x-2">
                  <Coins className="text-yellow-600 dark:text-yellow-400" size={20} />
                  <span className={`${canPayWithCoins ? 'text-gray-900 dark:text-white' : 'text-gray-400 dark:text-gray-600'}`}>
                    Pay with Coins
                  </span>
                </div>
              </label>
              ...
              {!canPayWithCoins && (
                <p className="text-sm text-red-600 dark:text-red-400 ml-6">
                  Insufficient coins. You have {user?.coins || 0} coins.
                </p>
              )}
            </div>
          </div>
          ...
          <button
            ...
            disabled={isProcessing || (paymentMethod === 'coins' && !canPayWithCoins)}
