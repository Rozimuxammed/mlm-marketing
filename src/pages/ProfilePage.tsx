...
import { User, Mail, CreditCard, Calendar, Hash, Settings, Key, Bell, Globe, Moon } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">{t('common.profile')}</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-500">{t('profile.referralCode')}</p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-500">{t('profile.currentPlan')}</p>
                      <p className="text-gray-900">{user?.currentPlan}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-500">{t('profile.planExpiry')}</p>
                      <p className="text-gray-900">{planExpiryDate.toLocaleDateString()}</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">{t('profile.theme')}</p>
