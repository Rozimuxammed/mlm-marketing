...
import { Search, Filter, Star, Coins, ShoppingCart, Eye } from 'lucide-react';
  ...
  const products = [
    {
      ...
      description: 'Complete course on digital marketing strategies and techniques',
      price: 99.99,
      coinPrice: 2000,
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <div className="flex items-center text-yellow-600 dark:text-yellow-400">
                        ...
                        <span className="text-sm">{product.coinPrice} coins</span>
                      </div>
                    </div>
                  </div>
